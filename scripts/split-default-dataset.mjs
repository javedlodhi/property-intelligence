...
const source = new URL("../public/dubai-land-transactions-2026.csv", import.meta.url);
...
console.log(`Split ${join(publicDirectory.pathname, "dubai-land-transactions-2026.csv")} into two Worker-compatible assets.`);
